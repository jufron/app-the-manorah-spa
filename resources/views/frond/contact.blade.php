        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto space-y-4">
                ...
                <p class="text-stone-600 dark:text-stone-300 text-base sm:text-lg leading-relaxed font-medium">
                    We are ready to answer your inquiries, provide treatment consultations, and process your home/villa spa reservations quickly and friendly via WhatsApp.
                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="p-6 rounded-3xl bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 space-y-4 hover:border-amber-500/50 transition-all duration-300 shadow-lg">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-stone-500 dark:text-stone-400">Call service headquarters</p>
                    </div>
                ...
                <div class="p-6 rounded-3xl bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 space-y-4 hover:border-amber-500/50 transition-all duration-300 shadow-lg">
                    ...
                    <div>
                        <h3 class="text-lg font-bold font-serif text-stone-900 dark:text-white">Opening Hours</h3>
                        <p class="text-xs text-stone-500 dark:text-stone-400">Open daily</p>
                    </div>
                    <p class="text-sm text-stone-600 dark:text-stone-300 font-medium">
                        {{ $settings['opening_hours'] ?? 'Monday - Sunday: 09:00 - 22:00 WITA' }}
                    </p>
                </div>
    ...
    <section class="py-16 bg-white dark:bg-stone-900/50 transition-colors duration-500">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 space-y-8">
            <div class="text-center max-w-2xl mx-auto space-y-3">
                ...
                <p class="text-sm text-stone-600 dark:text-stone-300 font-medium">
                    Our therapist operational headquarters is ready to serve Seminyak, Canggu, Kuta, Denpasar, Sanur, Ubud, Nusa Dua, and surrounding areas.
                </p>
            </div>
    ...
    <section class="py-20 bg-stone-50 dark:bg-stone-900">
        <div class="max-w-7xl mx-auto px-6 lg:px-8 space-y-12">
            <div class="text-center max-w-2xl mx-auto space-y-3">
                ...
                <p class="text-sm text-stone-600 dark:text-stone-300 font-medium">
                    Find quick answers regarding home call spa bookings.
                </p>
            </div>
